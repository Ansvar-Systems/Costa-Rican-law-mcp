/**
 * Tool registry for Costa Rican Law MCP Server.
...
import { getCostaRicanImplementations, type GetCostaRicanImplementationsInput } from './get-costa-rican-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the La Gaceta (Diario Oficial de Costa Rica). ' +
    ...
    'Call this FIRST when you need to understand what Costa Rican legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Costa Rican statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from a Costa Rican statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Costa Rican legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Costa Rican statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Costa Rican?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Costa Rican legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Costa Rican statute or provision is currently in force, amended, repealed, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get international legal instruments that a Costa Rican statute references or aligns with. ' +
      'Costa Rican laws may reference international standards and conventions ' +
      'where applicable. ' +
      'Returns EU document identifiers, reference types, and implementation status.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Costa Rican statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_costa_rican_implementations',
    description:
      'Find all Costa Rican statutes that reference or align with a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Costa Rican statutes. ' +
      'Costa Rican may reference international legal instruments where relevant.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Costa Rican legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_costa_rican_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Costa Rican legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU legal basis for a SPECIFIC provision within a Costa Rican statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU alignment status for a Costa Rican statute or provision. ' +
      ...
      'Costa Rican is an EU Member State; this checks implementation status and cross-references.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Costa Rican statute identifier.' },
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_costa_rican_implementations':
          result = await getCostaRicanImplementations(db, args as unknown as GetCostaRicanImplementationsInput);
          break;
