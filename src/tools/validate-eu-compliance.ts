/**
 * validate_eu_compliance — Check EU alignment status for an Costa Rican statute.
 */
  ...
  if (euRefCount === 0) {
    return {
      results: {
        ...
        eu_references_found: 0,
        warnings: [],
        recommendations: ['No EU cross-references found for this Costa Rican statute. Costa Rican is an EU Member State; EU references indicate transposition obligations.'],
      },
      _metadata: generateResponseMetadata(db),
    };
  }
