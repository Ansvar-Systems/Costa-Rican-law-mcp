#!/usr/bin/env tsx
/**
 * Database builder for Costa Rican Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Costa Rican Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Costa Rican statute text',
              );
